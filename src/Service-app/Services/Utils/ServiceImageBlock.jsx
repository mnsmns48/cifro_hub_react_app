import {Table, Button, Modal, Input, Space, message, Popconfirm, Typography, Empty} from "antd";
        ...
        <div style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
            <div style={{textAlign: "center", marginTop: 2, paddingBottom: 2}}>
                <Typography.Paragraph style={{fontSize: "12px", color: "#999", opacity: 0.9}}>
                    Загружаем в S3 файл, добавляем переменную, а значением будет называние файла <br/>
